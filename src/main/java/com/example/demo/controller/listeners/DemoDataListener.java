package com.example.demo.controller.listeners;
...
@Slf4j
public class DemoDataListener implements ReadListener<Book> {
     ...
     * @param service
     */
    public DemoDataListener(BookService service) {
     ...
     * 这个每一条数据解析都会来调用
     *
     * @param book    one row value. Is is same as {@link AnalysisContext#readRowHolder()}
     * @param context
     */
    @Override
